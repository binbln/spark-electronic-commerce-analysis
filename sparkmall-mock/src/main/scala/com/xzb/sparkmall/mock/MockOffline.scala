package com.xzb.sparkmall.mock

import java.text.SimpleDateFormat
import java.util.UUID

import com.xzb.sparkmall.common.bean.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.xzb.sparkmall.common.util.ConfigurationUtil
import com.xzb.sparkmall.mock.util.{RandomDate, RandomNumUtil, RandomOptions}
...
object MockOffline {
  ...
  def main(args: Array[String]): Unit = {
    ...
    System.setProperty("HADOOP_USER_NAME","xzb")
    // 模拟数据
