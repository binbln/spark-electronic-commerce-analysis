...
import com.xzb.sparkmall.common.bean.CityInfo
import com.xzb.sparkmall.mock.util.{RandomNumUtil, RandomOptions}
...
object MockRealTime {
  ...
  def createKafkaProducer: KafkaProducer[String, String] = {
    ...
    // Kafka服务端的主机名和端口号
    props.put("bootstrap.servers", "hadoop107:9092,hadoop108:9092,hadoop109:9092")
    // 等待所有副本节点的应答
    props.put("acks", "1")
    // 重试最大次数
    props.put("retries", "0")
